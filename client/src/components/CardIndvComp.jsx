...
const CardIndvComp = ({ image, onClick }) => {
  return (
    <div 
      className="hover:z-50 m-1 mx-auto overflow-hidden font-sans shadow-md cursor-pointer w-72 h-[350px] card-component bg-glass rounded-xl" 
      onClick={onClick}
    >
      <div className="flex-col pt-8 md:flex">
        <div className="md:flex-shrink-0 justify-center flex">
          <img className="object-cover w-full h-64 mx-2 rounded-xl md:w-48" src={image.imageUrl} alt={image.imageTitle} />
        </div>
        <div className="p-4">
